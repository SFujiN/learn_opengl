...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Basic Lighting: Exercise 2", NULL, NULL);
	if (window == NULL)
	{
	...
	Shader ourShader("../shaders/basic_lighting_ex2.vs", "../shaders/basic_lighting_ex2.fs");
