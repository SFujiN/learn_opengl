...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "Hello Triangle Exercise 2", NULL, NULL);
	if (window == NULL)
	{
	...
	unsigned int vertexShader, orangeShader, yellowShader, shaderProgram, shaderProgramYellow;
	...
	if(!success)
	{
		...
		std::cout << "ERROR::SHADER::ORANGE::COMPILATION_FAILED\n" << infoLog << std::endl;
	}
	...
	glAttachShader(shaderProgram, orangeShader);
